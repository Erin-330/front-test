...
const teams: Team[] = [
  ...
  { id: 'kt', name: 'KT Rolster', description: 'KT Rolster Challengers', logo: assets.ktRolster, hasBoost: true },
  { id: 'geng', name: 'Gen.G', description: 'Gen.G Esports', logo: assets.gengLogo, hasBoost: true },
  { id: 'hle', name: 'Hanwha Life', description: 'Hanwha Life Esports', logo: assets.t1Logo },
  { id: 'drx', name: 'DRX', description: 'DRX', logo: assets.ktRolster },
  { id: 'dk', name: 'Dplus KIA', description: 'Dplus KIA', logo: assets.gengLogo },
  { id: 'bro', name: 'BRO', description: 'OKSavingsBank BRION', logo: assets.t1Logo },
  { id: 'ns', name: 'NS', description: 'Nongshim RedForce', logo: assets.ktRolster },
  { id: 'kdf', name: 'KDF', description: 'Kwangdong Freecs', logo: assets.gengLogo },
  { id: 'fox', name: 'FearX', description: 'BNK FearX', logo: assets.t1Logo, hasBoost: true },
]
